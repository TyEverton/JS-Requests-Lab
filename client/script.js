...
sayHelloBtn.addEventListener("mouseover", changeColor)
...
sayHelloBtn.addEventListener("mouseout", revertColors)
...
const repeatMyParam = () => {
 ...
 axios
  .get("http://localhost:3000/repeat/")
  .then(function(res) {
...
function queryTest() {
    axios
    .get("http://localhost:3000/query-test/?name=ty)
    .then(function(res) {
    })
    .catch(function(error) { console.log(error)})
}
